...
const imageContainer = document.querySelector('.gallery__image-container6');
...
const modalImages = document.querySelector('.modal-gallery__background6');
...
thumnails.forEach(thumnail => {
    thumnail.addEventListener('click', event=>{
        ...
        imageContainer.style.backgroundImage = `url('../MEDIA/image-product6-${event.target.id}.png')`
...
const modalImageContainer = document.querySelector ('.modal-gallery__image-container6');
modalThumnails = [...modalThumnails]

modalThumnails.forEach(modalThumnail => {
    modalThumnail.addEventListener('click', event=>{
        console.log(event.target.id.slice(-1));
        modalImageContainer.style.backgroundImage = `url('../MEDIA/image-product6-${event.target.id.slice(-1)}.png')`
    })
});
...
function drawProductInmodal() {
    ...
    <img class="cart-modal__image" src="../MEDIA/image-product6-1.png" alt="">
    <div>
        <p class="cart-modal__product">Dickies Navy Blue </p>
        <p class="cart-modal__price">$200 x3 <span>$600</span></p>
    </div>
...
function changeNextImage(imgContainer) {
    ...
    imgContainer.style.backgroundImage = `url('../MEDIA/image-product6-${imgIndex}.png')`
