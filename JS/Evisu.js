...
const imageContainer = document.querySelector('.gallery__image-container5');
...
const modalImages = document.querySelector('.modal-gallery__background5');
...
thumnails.forEach(thumnail => {
    thumnail.addEventListener('click', event=>{
        ...
        imageContainer.style.backgroundImage = `url('../MEDIA/image-product5-${event.target.id}.png')`
...
const modalImageContainer = document.querySelector ('.modal-gallery__image-container5');
modalThumnails = [...modalThumnails]

modalThumnails.forEach(modalThumnail => {
    modalThumnail.addEventListener('click', event=>{
        console.log(event.target.id.slice(-1));
        modalImageContainer.style.backgroundImage = `url('../MEDIA/image-product5-${event.target.id.slice(-1)}.png')`
    })
});
...
function drawProductInmodal() {
    ...
    <img class="cart-modal__image" src="../MEDIA/image-product5-1.png" alt="">
    <div>
        <p class="cart-modal__product">Eviusu Short</p>
...
function changeNextImage(imgContainer) {
    ...
    imgContainer.style.backgroundImage = `url('../MEDIA/image-product5-${imgIndex}.png')`
