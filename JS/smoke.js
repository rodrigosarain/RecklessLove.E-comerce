...
const imageContainer = document.querySelector('.gallery__image-container2');
...
const modalImages = document.querySelector('.modal-gallery__background2');
...
thumnails.forEach(thumnail => {
    thumnail.addEventListener('click', event=>{
        ...
        imageContainer.style.backgroundImage = `url('../MEDIA/image-product2-${event.target.id}.png')`
...
const modalImageContainer = document.querySelector ('.modal-gallery__image-container2');
modalThumnails = [...modalThumnails]

modalThumnails.forEach(modalThumnail => {
    modalThumnail.addEventListener('click', event=>{
        console.log(event.target.id.slice(-1));
        modalImageContainer.style.backgroundImage = `url('../MEDIA/image-product2-${event.target.id.slice(-1)}.png')`
    })
});
...
function drawProductInmodal() {
    ...
    <div class="cart-modal__details-container">
                    <img class="cart-modal__image" src="../MEDIA/image-product2-1.png" alt="">
                    <div>
                        <p class="cart-modal__product">Smoke T-Shirt</p>
    ...
    pricesModal.innerHTML = `$100 x${lastValue} <span>$${lastValue*100}.00</span>`;
}
...
function changeNextImage(imgContainer) {
    ...
    imgContainer.style.backgroundImage = `url('../MEDIA/image-product2-${imgIndex}.png')`
